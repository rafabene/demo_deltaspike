...
public class CDIPropertyExtension implements Extension {
    ...
    public <T> void processAnnotatedType(@Observes ProcessAnnotatedType<T> pat) {
        ...
        if (pat.getAnnotatedType().getJavaClass().getPackage().getName().startsWith("org.tdc")) {
            logger.info("Scanning Classe do pacote org.tdc: " + pat.getAnnotatedType().getJavaClass().getName());
        }
